      ...
      <div className="p-3 flex flex-col gap-1 flex-1">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <button
            ...
            className="h-8 w-8 rounded-full bg-[#f4a52c] text-white flex items-center justify-center hover:bg-[#fa7a3d] transition disabled:bg-gray-300 disabled:cursor-not-allowed"
          >
